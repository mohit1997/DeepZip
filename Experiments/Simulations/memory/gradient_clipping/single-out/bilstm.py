...
from keras.layers import LSTM, Flatten, Bidirectional, CuDNNLSTM
...
def fit_lstm(X, Y, bs, nb_epoch, neurons):
	...
	model.add(Bidirectional(CuDNNLSTM(32, batch_input_shape=(bs, X.shape[1], 8), stateful=True, return_sequences=False)))
